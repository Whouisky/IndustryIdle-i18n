export const FR = {
    ...
    ResearchLabCultureInputDesc: "Le laboratoire de recherche a une capacité x2 mais prend la culture comme entrée supplémentaire",
    ...
    LeaderboardValuationPerBuilding: "Évaluation du bâtiment par bâtiment",
    BuildingCustomColor: "Couleur des Bâtiments",
    BuildingCustomColorReset: "Réinitialiser",
    Vancouver: "Vancouver",
    VancouverBonus:
    ...
    ResourceBoosterSupplyChainDesc:
        "Les boosters de ressources utilisent x2 de puissance et de science, mais pour chaque mine de travail, un booster de ressources augmente. Il offre également un augmentation de la capacité aux usines adjacentes qui consomment la production de la mine (l'usine ne devrait consommer que des dépôts)",
    ProductionDiversification: "Diversification de la production",
    ProductionDiversificationDesc: "Chaque type de bâtiment différent donne 1% de capacité supplémentaire à tous les bâtiments",
    ExtraPolicyPointsDescV2: "Centre politique a une capacité de conversion de points politiques x2",
    PowerRequired: "Puissance requise",
    AchievementVancouver100: "Vendeur de sève",
